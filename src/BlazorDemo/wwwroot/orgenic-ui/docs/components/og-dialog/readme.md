...
| `--og-dialog-Background`            | Background of the Dialog                                     | --OG-COLOR-SHADE--0 |
| `--og-dialog-BorderRadius`          | Corner Radius of the Dialog                                  | --OG-BORDER-RADIUS |
...
| `--og-dialog__header-FontWeight`    | Font Weight of the Dialog Header                             | --OG-FONT-WEIGHT--MEDIUM |
...
| `--og-dialog__svg-Height`           | Height of the Dialog Content Img                             | --og-dialog__svg-Width |
