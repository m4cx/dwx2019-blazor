...
class OgCalendar {
    constructor(hostRef) {
        ...
        this.selectionChanged = __chunk_1.createEvent(this, "selectionChanged", 7);
    ...
    handleDateClick(event) {
        ...
        const date = __chunk_3.CalendarUtils.moment2CalendarDate(event.detail);
        if (this.selectionType !== 'none') {
            if (this.selectionType === 'single' || !this.selection) {
                ...
                const index = this.selection.findIndex(s => __chunk_3.CalendarUtils.compareCalendarDate(s, date));
                if (index >= 0) {
    ...
    render() {
        ...
        for (let i = 0; i < this.displayedMonths; i++) {
            result.push(__chunk_1.h("div", { class: "calendar__container" }, __chunk_1.h("div", { class: "calendar__header" }, __chunk_1.h("div", { class: "calender__header__prefix" }, __chunk_1.h("span", { class: 'calendar__nav' + (i > 0 ? ' calendar__nav--hidden' : ''), onClick: () => this.decreaseMonth() }, __chunk_1.h("svg", { class: 'calendar__nav__icon', version: "1.1", xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", viewBox: "0 0 14 24", preserveAspectRatio: "none" }, __chunk_1.h("polyline", { class: "og-", points: "12,2 2,12 12,24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecaps": "round", "stroke-linejoin": "round" })))), __chunk_1.h("div", { class: "calender__header__main" }, __chunk_1.h("span", { class: "calender__header__month" }, localM.format('MMM')), __chunk_1.h("span", { class: "calender__header__year" }, localM.year())), __chunk_1.h("div", { class: "calender__header__suffix" }, __chunk_1.h("div", { class: 'calendar__nav' + (i < this.displayedMonths - 1 ? ' calendar__nav--hidden' : ''), onClick: () => this.increaseMonth() }, __chunk_1.h("svg", { class: 'calendar__nav__icon', version: "1.1", xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", viewBox: "0 0 14 24", preserveAspectRatio: "none" }, __chunk_1.h("polyline", { class: "og-", points: "2,2 12,12 2,24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecaps": "round", "stroke-linejoin": "round" }))))), __chunk_1.h("og-internal-calendar", { class: "calendar__main", month: localM.month(), year: localM.year(), loc: this.loc, showCalendarWeek: this.showCalendarWeek, dateDecorator: this.dateDecorator, selection: this.selection, onDateClicked: (e) => this.handleDateClick(e) })));
            localM.add(1, 'M');
        }
        return result;
    }
...
exports.og_calendar = OgCalendar;
