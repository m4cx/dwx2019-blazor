...
class OgExpander {
    ...
    render() {
        return (__chunk_1.h(__chunk_1.Host, { class: { 'og-expander': true } }, __chunk_1.h("div", { class: "og-expander__header", onClick: () => { this.toggleExpandedState(); } }, __chunk_1.h("span", { class: "og-expander__title" }, this.name), __chunk_1.h("div", { class: "og-expander__button" }, __chunk_1.h("svg", { class: 'og-expander__button__arrow' +
                (this.expanded
                    ? ' og-expander__button__arrow--collapsed'
                    : ''), version: "1.1", xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", viewBox: "0 0 24 12", preserveAspectRatio: "none" }, __chunk_1.h("polyline", { class: "og-expander__button__arrow__line", points: "0,0 12,12 24,0", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecaps": "round", "stroke-linejoin": "round" })))), __chunk_1.h("div", { class: "og-expander__content", "data-expanded": this.expanded }, __chunk_1.h("slot", null))));
    }
...
exports.og_expander = OgExpander;
