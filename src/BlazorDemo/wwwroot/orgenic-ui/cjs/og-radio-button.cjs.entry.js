...
class OgRadioButton {
    ...
    render() {
        return (__chunk_1.h(__chunk_1.Host, { class: {
            ...
            } }, __chunk_1.h("input", { type: "radio", id: this.internalId, name: this.name, checked: this.checked, disabled: this.disabled || this.groupDisabled, class: "og-radio-button__input", onChange: (e) => this.eventInputChanged(e) }), __chunk_1.h("label", { class: "og-radio-button__label", htmlFor: this.internalId }, this.label && __chunk_1.h("span", { class: "og-radio-button__label__content" }, this.label))));
    }
...
exports.og_radio_button = OgRadioButton;
