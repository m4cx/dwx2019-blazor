...
class OgCard {
    ...
    render() {
        return (__chunk_1.h("div", { class: "og-card" }, this.name
            ? __chunk_1.h("div", { class: "og-card__header" }, __chunk_1.h("span", { class: "og-card__title" }, this.name))
            : "", __chunk_1.h("div", { class: "og-card__content" }, __chunk_1.h("slot", null), __chunk_1.h("slot", { name: "content" })), __chunk_1.h("div", { class: "og-card__footer", ref: el => this.handleDivRef(el) }, __chunk_1.h("slot", { name: "footer" }))));
    }
