...
class OgToggleSwitch {
    ...
    render() {
        return [
            __chunk_1.h("input", { type: "checkbox", id: this.internalId, class: "og-toggle-switch__input", checked: this.value, disabled: this.disabled, onChange: (event) => this.handleChange(event) }),
            __chunk_1.h("label", { class: "og-toggle-switch__toggle", htmlFor: this.internalId, tabindex: "0" })
        ];
    }
...
exports.og_toggle_switch = OgToggleSwitch;
