...
class OgFormItem {
    ...
    render() {
        return __chunk_1.h(__chunk_1.Host, { class: {
            ...
            } }, __chunk_1.h("label", { class: "og-form-item", htmlFor: "input#1" }, __chunk_1.h("div", { class: "og-form-item__body" }, __chunk_1.h("div", { class: "og-form-item__label" }, this.label), __chunk_1.h("slot", null))));
    }
...
exports.og_form_item = OgFormItem;
