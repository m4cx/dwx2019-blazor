...
class OgCheckbox {
    ...
    render() {
        return (h(Host, { class: {
            ...
            } }, h("input", { class: "og-checkbox__input", type: "checkbox", id: this.internalId, checked: this.checked, disabled: this.disabled, onChange: (event) => this.handleChange(event) }), h("label", { class: "og-checkbox__label", htmlFor: this.internalId }, this.label && h("span", { class: "og-checkbox__label__content" }, this.label))));
    }
