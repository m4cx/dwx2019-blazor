...
class OgCombobox {
    ...
    render() {
        return (h(Host, { class: {
            ...
            } }, h("div", { class: "og-combobox__header", onClick: () => this.buttonClicked() }, h("input", { type: "text", class: "og-combobox__input", readonly: "true", value: this.getSelectedItemLabel(), placeholder: this.placeholder, disabled: this.disabled }), h("div", { class: "og-combobox__button" }, h("svg", { class: 'og-combobox__button__arrow' +
                (this.isDropdownActive() ? ' og-combobox__button__arrow--collapsed' : ''), version: "1.1", xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", viewBox: "0 0 24 12", preserveAspectRatio: "none" }, h("polyline", { class: "og-combobox__button__arrow__line", points: "0,0 12,12 24,0", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecaps": "round", "stroke-linejoin": "round" }))), h("div", { class: "og-combobox__indicator", ref: (el) => this.indicatorElement = el })), h("div", { class: "og-combobox__flyout" }, h("ul", { class: 'og-combobox__flyout__list' +
