...
var tabulator = createCommonjsModule(function (module, exports) {
    ...
    (function (global, factory) {
        ...
        ColumnManager.prototype.getComponents = function (structured) {
            var self = this, output = [], columns = structured ? self.columns : self.columnsByIndex;
        ...
        ColumnManager.prototype._moveColumnInArray = function (columns, from, to, after, updateRows) {
            var fromIndex = columns.indexOf(from), toIndex;
            if (fromIndex > -1) {
        ...
        ColumnManager.prototype.getFlexBaseWidth = function () {
            var self = this, totalWidth = self.table.element.clientWidth, 
            //table element width
            fixedWidth = 0;
        ...
        Column.prototype.setTooltip = function () {
            var self = this, def = self.definition;
            //set header tooltips
        ...
        Column.prototype._bindEvents = function () {
            var self = this, def = self.definition, dblTap, tapHold, tap;
        ...
        Column.prototype._buildColumnHeader = function () {
            var self = this, def = self.definition, table = self.table;
            //set column sorter
        ...
        RowManager.prototype.scrollToRow = function (row, position, ifVisible) {
            var _this2 = this;
            var rowIndex = this.getDisplayRows().indexOf(row), rowEl = row.getElement(), rowTop, offset = 0;
            return new Promise(function (resolve, reject) {
                if (rowIndex > -1) {
                    if (typeof position === "undefined") {
        ...
        RowManager.prototype.addRowActual = function (data, pos, index, blockRedraw) {
            var row = data instanceof Row ? data : new Row(data || {}, this), top = this.findAddRowPos(pos), dispRows;
            ...
            if (index) {
                var allIndex = this.rows.indexOf(index), activeIndex = this.activeRows.indexOf(index);
                this.displayRowIterator(function (rows) {
        ...
        RowManager.prototype.getHtml = function (active) {
            var data = this.getData(active), columns = [], header = "", body = "", table = "";
            //build header row
        ...
        RowManager.prototype._genRemoteRequest = function () {
            var self = this, table = self.table, options = table.options, params = {};
        ...
        RowManager.prototype.filterRefresh = function () {
            var table = this.table, options = table.options, left = this.scrollLeft;
            if (options.ajaxFiltering) {
        ...
        RowManager.prototype.sorterRefresh = function (loadOrignalData) {
            var table = this.table, options = this.table.options, left = this.scrollLeft;
            if (options.ajaxSorting) {
        ...
        RowManager.prototype.refreshActiveData = function (stage, skipStage, renderInPosition) {
            var self = this, table = this.table, displayIndex;
        ...
        RowManager.prototype.checkClassicModeGroupHeaderWidth = function () {
            var self = this, element = this.tableElement, onlyGroupHeaders = true;
        ...
        RowManager.prototype._virtualRenderFill = function (position, forceMove, offset) {
            var self = this, element = self.tableElement, holder = self.element, topPad = 0, rowsHeight = 0, topPadHeight = 0, i = 0, onlyGroupHeaders = true, rows = self.getDisplayRows();
            position = position || 0;
            offset = offset || 0;
            if (!position) {
            ...
            if (self.displayRowsCount && Tabulator.prototype.helpers.elVisible(self.element)) {
                ...
                while ((rowsHeight <= self.height + self.vDomWindowBuffer || i < self.vDomWindowMinTotalRows) && self.vDomBottom < self.displayRowsCount - 1) {
                    var index = self.vDomBottom + 1, row = rows[index], rowHeight = 0;
                    self.styleRow(row, index);
                    element.appendChild(row.getElement());
                    if (!row.initialized) {
                        row.initialize(true);
        ...
        RowManager.prototype._addTopRow = function (topDiff) {
            ...
            var table = this.tableElement, rows = this.getDisplayRows();
            if (this.vDomTop) {
        ...
        RowManager.prototype._removeTopRow = function (topDiff) {
            var table = this.tableElement, topRow = this.getDisplayRows()[this.vDomTop], topRowHeight = topRow.getHeight() || this.vDomRowHeight;
            if (topDiff >= topRowHeight) {
        ...
        RowManager.prototype._removeBottomRow = function (bottomDiff) {
            var table = this.tableElement, bottomRow = this.getDisplayRows()[this.vDomBottom], bottomRowHeight = bottomRow.getHeight() || this.vDomRowHeight;
            if (bottomDiff >= bottomRowHeight) {
        ...
        Row.prototype.generateElement = function () {
            var self = this, dblTap, tapHold, tap;
        ...
        Row.prototype.updateData = function (data) {
            var _this5 = this;
            var self = this, visible = Tabulator.prototype.helpers.elVisible(this.element);
            return new Promise(function (resolve, reject) {
        ...
        Row.prototype.findPrevEditableCell = function (index) {
            ...
            if (index > 0) {
                for (var i = index - 1; i >= 0; i--) {
                    var cell = this.cells[i], allowEdit = true;
                    if (cell.column.modules.edit && Tabulator.prototype.helpers.elVisible(cell.getElement())) {
                        if (typeof cell.column.modules.edit.check == "function") {
                            allowEdit = cell.column.modules.edit.check(cell.getComponent());
                        }
        ...
        Cell.prototype._configureCell = function () {
            var self = this, cellEvents = self.column.cellEvents, element = self.element, field = this.column.getField();
            //set text alignment
        ...
        Cell.prototype._bindTouchEvents = function (cellEvents) {
            var self = this, element = self.element, dblTap, tapHold, tap;
        ...
        Cell.prototype.setValue = function (value, mutate) {
            var changed = this.setValueProcessData(value, mutate), component;
            if (changed) {
                if (this.table.options.history && this.table.modExists("history")) {
        ...
        Cell.prototype.nav = function () {
            var self = this, nextCell = false, index = this.row.getCellIndex(this);
            return {
                next: function next() {
                    var nextCell = this.right(), nextRow;
                    if (!nextCell) {
                ...
                prev: function prev() {
                    var nextCell = this.left(), prevRow;
                    if (!nextCell) {
        ...
        Tabulator.prototype._buildElement = function () {
            ...
            if (options.initialHeaderFilter && this.modExists("filter", true)) {
                options.initialHeaderFilter.forEach(function (item) {
                    var column = _this7.columnManager.findColumn(item.field);
                    if (column) {
        ...
        Tabulator.prototype.setDataFromLocalFile = function (extensions) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                input.addEventListener("change", function (e) {
                    var file = input.files[0], reader = new FileReader(), data;
                    ...
                    reader.onload = function (e) {
                        ...
                        _this8._setData(data).then(function (data) {
                            resolve(data);
                        }).catch(function (err) {
                            resolve(err);
                        });
        ...
        Tabulator.prototype.addData = function (data, pos, index) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                if (data) {
                    _this10.rowManager.addRows(data, pos, index).then(function (rows) {
                        var output = [];
                        rows.forEach(function (row) {
                            output.push(row.getComponent());
                        });
        ...
        Tabulator.prototype.updateOrAddData = function (data) {
            var _this11 = this;
            var self = this, rows = [], responses = 0;
            return new Promise(function (resolve, reject) {
        ...
        Tabulator.prototype.addRow = function (data, pos, index) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                _this13.rowManager.addRows(data, pos, index).then(function (rows) {
                    //recalc column calculations if present
                    if (_this13.modExists("columnCalcs")) {
                        _this13.modules.columnCalcs.recalc(_this13.rowManager.activeRows);
                    }
        ...
        Tabulator.prototype.updateOrAddRow = function (index, data) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                if (row) {
                    ...
                    row = _this14.rowManager.addRows(data).then(function (rows) {
                        //recalc column calculations if present
                        if (_this14.modExists("columnCalcs")) {
                            _this14.modules.columnCalcs.recalc(_this14.rowManager.activeRows);
                        }
        ...
        Tabulator.prototype.scrollToRow = function (index, position, ifVisible) {
            ...
            return new Promise(function (resolve, reject) {
                ...
                if (row) {
                    _this16.rowManager.scrollToRow(row, position, ifVisible).then(function () {
                        resolve();
                    }).catch(function (err) {
                        reject(err);
                    });
        ...
        Tabulator.prototype.scrollToColumn = function (field, position, ifVisible) {
            var _this17 = this;
            return new Promise(function (resolve, reject) {
                var column = _this17.columnManager.findColumn(field);
                if (column) {
                    _this17.columnManager.scrollToColumn(column, position, ifVisible).then(function () {
                        resolve();
                    }).catch(function (err) {
                        reject(err);
                    });
        ...
        Tabulator.prototype.setPageToRow = function (row) {
            var _this18 = this;
            return new Promise(function (resolve, reject) {
                if (_this18.options.pagination && _this18.modExists("page")) {
                    row = _this18.rowManager.findRow(row);
                    if (row) {
                        _this18.modules.page.setPageToRow(row).then(function () {
                            resolve();
                        }).catch(function () {
                            reject();
                        });
        ...
        Layout.prototype.modes = {
            ...
            "fitColumns": function fitColumns(columns) {
                ...
                function scaleColumns(columns, freeSpace, colWidth, shrinkCols) {
                    var oversizeCols = [], oversizeSpace = 0, remainingSpace = 0, nextColWidth = 0, gap = 0, changeUnits = 0, undersizeCols = [];
        ...
        Comms.prototype.getConnections = function (selectors) {
            var self = this, connections = [], connection;
        ...
        Comms.prototype.send = function (selectors, module, action, data) {
            var self = this, connections = this.getConnections(selectors);
        ...
        Accessor.prototype.initializeColumn = function (column) {
            var self = this, match = false, config = {};
        ...
        Accessor.prototype.transformRow = function (dataIn, type) {
            var self = this, key = "accessor" + (type.charAt(0).toUpperCase() + type.slice(1));
        ...
        Ajax.prototype._loadDataStandard = function (inPosition) {
            var _this19 = this;
            return new Promise(function (resolve, reject) {
                _this19.sendRequest(inPosition).then(function (data) {
                    _this19.table.rowManager.setData(data, inPosition).then(function () {
                        resolve();
                    }).catch(function (e) {
                        reject(e);
                    });
        ...
        Ajax.prototype.sendRequest = function (silent) {
            var _this20 = this;
            var self = this, url = self.url, requestNo;
            self.requestOrder++;
            requestNo = self.requestOrder;
            self._loadDefaultConfig();
            return new Promise(function (resolve, reject) {
                if (self.table.options.ajaxRequesting.call(_this20.table, self.url, self.params) !== false) {
                    self.loading = true;
                    if (!silent) {
                        self.showLoader();
                    }
                    _this20.loaderPromise(url, self.config, self.params).then(function (data) {
        ...
        ColumnCalcs.prototype.generateRow = function (pos, data) {
            var self = this, rowData = this.generateRowData(pos, data), row;
            if (self.table.modExists("mutator")) {
        ...
        ColumnCalcs.prototype.getGroupResults = function (group) {
            var self = this, groupObj = group._getSelf(), subGroups = group.getSubGroups(), subGroupResults = {}, results = {};
        ...
        Clipboard.prototype.generateColumnGroupHeaders = function (columns) {
            ...
            this.table.columnManager.columns.forEach(function (column) {
                var colData = _this21.processColumnGroup(column);
                if (colData) {
                    output.push(colData);
                }
            });
        ...
        Clipboard.prototype.rowsToData = function (rows, config, params) {
            var columns = this.table.columnManager.columnsByIndex, data = [];
            rows.forEach(function (row) {
                var rowArray = [], rowData = row instanceof RowComponent ? row.getData("clipboard") : row;
                columns.forEach(function (column) {
                    var value = column.getFieldValue(rowData);
                    switch (typeof value === 'undefined' ? 'undefined' : _typeof(value)) {
                        case "object":
        ...
        Clipboard.prototype.buildComplexRows = function (config) {
            var _this23 = this;
            var output = [], groups = this.table.modules.groupRows.getGroups();
            groups.forEach(function (group) {
                output.push(_this23.processGroupData(group));
            });
            return output;
        };
        ...
        Clipboard.prototype.buildOutput = function (rows, config, params) {
            var _this25 = this;
            var output = [], calcs, columns = this.table.columnManager.columnsByIndex;
            if (config.columnHeaders) {
            ...
            if (config.rowGroups) {
                rows.forEach(function (row) {
                    output = output.concat(_this25.parseRowGroupData(row, config, params, calcs || {}));
                });
            }
            else {
        ...
        Clipboard.prototype.parseRowGroupData = function (group, config, params, calcObj) {
            ...
            if (group.subGroups) {
                group.subGroups.forEach(function (subGroup) {
                    groupData = groupData.concat(_this26.parseRowGroupData(subGroup, config, params, calcObj[group.key] ? calcObj[group.key].groups || {} : {}));
                });
            }
            else {
                if (config.columnCalcs) {
        ...
        Clipboard.prototype.generateHTML = function (rows, columns, calcs, config, params) {
            var self = this, headers = [], body, oddRow, evenRow, calcRow, firstRow, firstCell, firstGroup, lastCell, styleCells;
            ...
            function processRows(rowArray) {
                ...
                rowArray.forEach(function (row, i) {
                    var rowEl = document.createElement("tr"), styleRow = firstRow, isCalc = false, rowData;
                    ...
                    columns.forEach(function (column, j) {
                        var cellEl = document.createElement("td"), value = column.getFieldValue(rowData);
                        switch (typeof value === 'undefined' ? 'undefined' : _typeof(value)) {
                            case "object":
                                value = JSON.stringify(value);
                                break;
            ...
            function processGroup(group, calcObj) {
                var groupEl = document.createElement("tr"), groupCellEl = document.createElement("td");
        ...
        DataTree.prototype.generateControlElement = function (row, el) {
            var _this27 = this;
            var config = row.modules.dataTree, el = el || row.getCells()[0].getElement(), oldControl = config.controlEl;
            if (config.children !== false) {
                if (config.open) {
                    config.controlEl = this.collapseEl.cloneNode(true);
                    config.controlEl.addEventListener("click", function (e) {
                        e.stopPropagation();
                        _this27.collapseRow(row);
                    });
                }
                else {
            ...
            rows.forEach(function (row, i) {
                ...
                if (row instanceof Row) {
                    ...
                    if (!config.index && config.children !== false) {
                        children = _this28.getChildren(row);
        ...
        DataTree.prototype.getChildren = function (row) {
            ...
            if (config.children !== false && config.open) {
                ...
                children.forEach(function (child) {
                    output.push(child);
                    var subChildren = _this29.getChildren(child);
        ...
        DataTree.prototype.generateChildren = function (row) {
            ...
            childArray.forEach(function (childData) {
                var childRow = new Row(childData || {}, _this30.table.rowManager);
                childRow.modules.dataTree.index = row.modules.dataTree.index + 1;
                childRow.modules.dataTree.parent = row;
                if (childRow.modules.dataTree.children) {
                    childRow.modules.dataTree.open = _this30.startOpen(childRow.getComponent(), childRow.modules.dataTree.index);
                }
        ...
        Download.prototype.download = function (type, filename, options, interceptCallback) {
            var self = this, downloadFunc = false;
            this.processConfig();
        ...
        Download.prototype.processDefinitions = function () {
            var self = this, processedDefinitions = [];
        ...
        Download.prototype.processColumnGroup = function (column) {
            ...
            if (subGroups.length) {
                ...
                groupData.width = 0;
                subGroups.forEach(function (subGroup) {
                    var subGroupData = _this31.processColumnGroup(subGroup);
        ...
        Download.prototype.processData = function () {
            var _this32 = this;
            var self = this, data = [], groups = [], calcs = {};
            if (this.config.rowGroups) {
                groups = this.table.modules.groupRows.getGroups();
                groups.forEach(function (group) {
                    data.push(_this32.processGroupData(group));
                });
            }
            else {
        ...
        Download.prototype.processGroupData = function (group) {
            ...
            if (subGroups.length) {
                groupData.subGroups = [];
                subGroups.forEach(function (subGroup) {
                    groupData.subGroups.push(_this33.processGroupData(subGroup));
                });
            }
            else {
        ...
        Download.prototype.downloaders = {
            csv: function csv(columns, data, options, setFileContents, config) {
                var self = this, titles = [], fields = [], delimiter = options && options.delimiter ? options.delimiter : ",", fileContents, output;
            ...
            pdf: function pdf(columns, data, options, setFileContents, config) {
                var self = this, fields = [], header = [], body = [], calcs = {}, headerDepth = 1, autoTableParams = {}, rowGroupStyles = options.rowGroupStyles || {
                    fontStyle: "bold",
                    fontSize: 12,
                    cellPadding: 6,
                    fillColor: 220
                ...
                function parseColumnGroup(column, level) {
                    var colSpan = column.width, rowSpan = 1, col = {
            ...
            xlsx: function xlsx(columns, data, options, setFileContents, config) {
                var self = this, sheetName = options.sheetName || "Sheet1", workbook = { SheetNames: [], Sheets: {} }, calcs = {}, groupRowIndexs = [], groupColumnIndexs = [], output;
                if (config.columnCalcs) {
                    calcs = data.calcs;
                    data = data.data;
                }
                function generateSheet() {
                    var titles = [], fields = [], rows = [], worksheet;
        ...
        Edit.prototype.bindEditor = function (cell) {
            var self = this, element = cell.getElement();
        ...
        Edit.prototype.edit = function (cell, e, forceEdit) {
            var self = this, allowEdit = true, rendered = function rendered() { }, element = cell.getElement(), cellEditor, component, params;
        ...
        Edit.prototype.editors = {
            ...
            textarea: function textarea(cell, onRendered, success, cancel, editorParams) {
                var cellValue = cell.getValue(), value = String(cellValue !== null && cellValue !== "undefined" ? cellValue : ""), count = (value.match(/(?:\r\n|\r|\n)/g) || []).length + 1, input = document.createElement("textarea"), scrollHeight = 0;
                //create and style input
            ...
            select: function select(cell, onRendered, success, cancel, editorParams) {
                var self = this, cellEl = cell.getElement(), initialValue = cell.getValue(), input = document.createElement("input"), listEl = document.createElement("div"), dataItems = [], displayItems = [], currentItem = {}, blurable = true;
                ...
                function getUniqueColumnValues() {
                    var output = {}, column = cell.getColumn()._getSelf(), data = self.table.getData();
                    data.forEach(function (row) {
            ...
            autocomplete: function autocomplete(cell, onRendered, success, cancel, editorParams) {
                var self = this, cellEl = cell.getElement(), initialValue = cell.getValue(), input = document.createElement("input"), listEl = document.createElement("div"), allItems = [], displayItems = [], values = [], currentItem = {}, blurable = true;
                function getUniqueColumnValues() {
                    var output = {}, column = cell.getColumn()._getSelf(), data = self.table.getData();
                    data.forEach(function (row) {
                        var val = column.getFieldValue(row);
                ...
                function filterList(term, intialLoad) {
                    var matches = [], searchObjs = [], searchResults = [];
                    if (editorParams.searchFunc) {
            ...
            tickCross: function tickCross(cell, onRendered, success, cancel, editorParams) {
                var value = cell.getValue(), input = document.createElement("input"), tristate = editorParams.tristate, indetermValue = typeof editorParams.indeterminateValue === "undefined" ? null : editorParams.indeterminateValue, indetermState = false;
        ...
        Filter.prototype.initializeColumn = function (column, value) {
            var self = this, field = column.getField(), prevSuccess;
            //handle successfull value change
            function success(value) {
                var filterType = column.modules.filter.tagType == "input" && column.modules.filter.attrType == "text" || column.modules.filter.tagType == "textarea" ? "partial" : "match", type = "", filterFunc;
        ...
        Filter.prototype.search = function (searchType, field, type, value) {
            var self = this, activeRows = [], filterList = [];
            if (!Array.isArray(field)) {
                field = [{ field: field, type: type, value: value }];
            }
            field.forEach(function (filter) {
        ...
        Filter.prototype.filter = function (rowList, filters) {
            var self = this, activeRows = [], activeRowComponents = [];
        ...
        Filter.prototype.filterRow = function (row, filters) {
            var self = this, match = true, data = row.getData();
            self.filterList.forEach(function (filter) {
        ...
        Format.prototype.initializeColumn = function (column) {
            var self = this, config = { params: column.definition.formatterParams || {} };
            //set column formatter
        ...
        Format.prototype.formatters = {
            ...
            link: function link(cell, formatterParams, onRendered) {
                var value = cell.getValue(), urlPrefix = formatterParams.urlPrefix || "", label = this.emptyToSpace(value), el = document.createElement("a"), data;
        ...
        Group.prototype.addBindings = function () {
            var self = this, dblTap, tapHold, tap, toggleElement;
        ...
        GroupRows.prototype.initialize = function () {
            var self = this, groupBy = self.table.options.groupBy, startOpen = self.table.options.groupStartOpen, groupHeader = self.table.options.groupHeader;
        ...
        GroupRows.prototype.generateGroups = function (rows) {
            var self = this, oldGroups = self.groups;
            self.groups = {};
            self.groupList = [];
        ...
        HtmlTableImport.prototype.parseTable = function () {
            var self = this, element = self.table.element, options = self.table.options, columns = options.columns, headers = element.getElementsByTagName("th"), rows = element.getElementsByTagName("tbody")[0], data = [];
            self.hasIndex = false;
        ...
        HtmlTableImport.prototype._extractHeaders = function (headers, rows) {
            for (var index = 0; index < headers.length; index++) {
                var header = headers[index], exists = false, col = this._findCol(header.textContent), width, attributes;
                if (col) {
                    exists = true;
                }
                else {
        ...
        MoveColumns.prototype.bindTouchEvents = function (column) {
            var self = this, colEl = column.getElement(), startXMove = false, nextCol, prevCol, nextColWidth, prevColWidth, nextColWidthLast, prevColWidthLast;
        ...
        MoveColumns.prototype.moveHover = function (e) {
            var self = this, columnHolder = self.table.columnManager.getElement(), scrollLeft = columnHolder.scrollLeft, xPos = (self.touchMove ? e.touches[0].pageX : e.pageX) - Tabulator.prototype.helpers.elOffset(columnHolder).left + scrollLeft, scrollPos;
        ...
        MoveRows.prototype.initializeCell = function (cell) {
            var self = this, cellEl = cell.getElement();
        ...
        MoveRows.prototype.bindTouchEvents = function (row, element) {
            var self = this, startYMove = false, nextRow, prevRow, nextRowHeight, prevRowHeight, nextRowHeightLast, prevRowHeightLast;
            element.addEventListener("touchstart", function (e) {
                self.checkTimeout = setTimeout(function () {
                    self.touchMove = true;
                    nextRow = row.nextRow();
        ...
        MoveRows.prototype.connectToTables = function (row) {
            var connections = this.table.modules.comms.getConnections(this.connection);
        ...
        Mutator.prototype.transformRow = function (data, type, update) {
            var self = this, key = "mutator" + (type.charAt(0).toUpperCase() + type.slice(1)), value;
            if (this.enabled) {
                self.table.columnManager.traverse(function (column) {
        ...
        Page.prototype._getRemotePage = function () {
            var _this46 = this;
            var self = this, oldParams, pageParams;
            return new Promise(function (resolve, reject) {
        ...
        Page.prototype._parseRemoteData = function (data) {
            var self = this, left, data, margin;
        ...
        Persistence.prototype.retreiveData = function (type) {
            var data = "", id = this.id + (type === "columns" ? "" : "-" + type);
            switch (this.mode) {
                case "local":
                ...
                case "cookie":
                    //find cookie
                    var cookie = document.cookie, cookiePos = cookie.indexOf(id + "="), end = void 0;
        ...
        ResizeColumns.prototype.initializeColumn = function (type, column, element) {
            var self = this, variableHeight = false, mode = this.table.options.resizableColumns;
        ...
        ResponsiveLayout.prototype.layoutRow = function (row) {
            var rowEl = row.getElement(), el = document.createElement("div");
        ...
        ResponsiveLayout.prototype.generateCollapsedContent = function () {
            var self = this, rows = this.table.rowManager.getDisplayRows();
            rows.forEach(function (row) {
        ...
        ResponsiveLayout.prototype.generateCollapsedRowData = function (row) {
            var self = this, data = row.getData(), output = [], mockCellComponent;
        ...
        ResponsiveLayout.prototype.formatCollapsedData = function (data) {
            var list = document.createElement("table"), listContents = "";
            data.forEach(function (item) {
        ...
        Sort.prototype.initializeColumn = function (column, content) {
            var self = this, sorter = false, colEl, arrowEl;
...
function applyCustomTableConfig(config, tableConfig) {
...
function getColumnConfig(columns) {
    return columns.map(function (column) {
        ...
        if (column.sorter) {
            var sorterFn_1 = column.sorter;
            columnDef.sorter = function (a, b) {
                return sorterFn_1(a, b);
            };
        }
        return columnDef;
    });
}
function applyDataServiceConfig(dataService, tableConfig) {
    var provider;
    if (!dataService) {
...
var OgDatatable = /** @class */ (function () {
    function OgDatatable(hostRef) {
        registerInstance(this, hostRef);
        this.itemSelected = createEvent(this, "itemSelected", 7);
    }
    OgDatatable.prototype.configChanged = function () {
        this.initTable();
    };
    /**
     * Programatically update selected row by idProperty.
     */
    OgDatatable.prototype.setSelection = function (id) {
     ...
     */
    OgDatatable.prototype.reloadData = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (this.table) {
    ...
    OgDatatable.prototype.initTable = function () {
        var _this_1 = this;
        if (this.table || !this.tableContainer || !this.config) {
            return;
        }
        var tableConfig = getBasicTableConfig();
        if (this.config) {
        ...
        tableConfig.rowClick = function (_e, row) {
            var data = row.getData();
            _this_1.selected = data[_this_1.table.options.index];
            _this_1.itemSelected.emit(data);
        },
            tableConfig.dataLoaded = function () { return _this_1.updateRowSelection(); };
        tableConfig.ajaxRequestFunc = function (url, config, params) { return _this_1.requestFunc(url, config, params); },
            this.table = new tabulator(this.tableContainer, tableConfig);
    };
    OgDatatable.prototype.updateRowSelection = function () {
        var _this_1 = this;
        if (!this.table) {
            // console.log('update row selection - no table');
            return;
        }
        if (this.table.getData().findIndex(function (d) { return d[_this_1.table.options.index] == _this_1.selected; }) <= 0) {
            // console.log('update row selection - selection not in table data');
            return;
        }
        this.table.selectRow(this.selected);
    };
    OgDatatable.prototype.requestFunc = function (_url, _config, params) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!params.page) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.dataProvider.getData()];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2: return [4 /*yield*/, this.dataProvider.getData(params.page, params.size, params.sorters)];
                    case 3:
                        result = _a.sent();
                        return [2 /*return*/, {
    ...
    OgDatatable.prototype.render = function () {
        var _this_1 = this;
        return h("div", { ref: function (el) { _this_1.tableContainer = el; _this_1.initTable(); }, class: this.config && this.config.dataService && this.config.dataService.type === 'scrolled' ? 'scrolled-table--limited-height' : '' });
    };
    Object.defineProperty(OgDatatable, "watchers", {
        get: function () {
            return {
