...
var OgCard = /** @class */ (function () {
    function OgCard(hostRef) {
        registerInstance(this, hostRef);
    }
    OgCard.prototype.handleDivRef = function (el) {
        if (!el) {
            return;
        }
        var slot = el.firstChild;
        if (!slot) {
            return;
        }
