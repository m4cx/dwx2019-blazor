...
var CalendarUtils = /** @class */ (function () {
    ...
    CalendarUtils.compareCalendarDate = function (date1, date2) {
        return date1.year === date2.year && date1.month === date2.month && date1.date === date2.date;
    };
    CalendarUtils.compareCalendarDate2Moment = function (date, moment) {
        return date.year === moment.get('y') && date.month === moment.get('M') && date.date === moment.get('D');
    };
    CalendarUtils.moment2CalendarDate = function (moment) {
        return { year: moment.get('y'), month: moment.get('M'), date: moment.get('D') };
    };
    CalendarUtils.calendarDate2Moment = function (date, locale) {
        if (!date) {
            return;
        }
        var result = hooks();
...
function loadMomentLocale(locale, moment) {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    url = "/orgenic-ui-assets/og-calendar-locales/" + locale + ".mjs";
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 3, , 4]);
                ...
                case 3:
                    e_1 = _b.sent();
                    console.log('unable to retreive og-calendar-locale', e_1);
                    return [3 /*break*/, 4];
...
export { CalendarUtils as C, getDefaultLocale as g, loadMomentLocale as l, hooks as m };
